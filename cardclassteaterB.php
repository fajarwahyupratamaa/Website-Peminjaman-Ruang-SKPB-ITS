...
?>
    <!-- Carousel -->
   <section id="carouselteaterb" class="pt-48 pb-16">
    <div class="max-w-3xl mx-auto ">
        ...
        <div id="default-carousel" class="sticky" data-carousel="static">
            ...
            <div class="overflow-hidden relative h-96 rounded-lg ">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/teater/teaterb-2.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
               
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/teater/teaterb.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
