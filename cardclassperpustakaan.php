...
?>
    ...
    <!-- Carousel -->
   <section id="carouselperpustakaan" class="pt-48 pb-16">
        ...
        <div id="default-carousel" class="sticky" data-carousel="static">
            ...
            <div class="overflow-hidden relative h-96 rounded-lg ">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    ...
                    <img src="dist/img/perpus/perpus606.webp" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
               
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/perpus/perpus604.webp" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
               
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/perpus/perpus605-1.webp" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
...
<section id="rincianruanganperpustakaan" class="pt-10 pb-10 bg-slate-100">
    <div class="container">
        <div class="w-full px-4">
            <div class="max-w-xl mx-auto text-center mb-16">
                <h3 class="font-semibold text-lg text-primary mb-2">Rincian Ruangan di Perpustakaan</h3>
        ...
        <div class="flex flex-wrap">
            <div class="w-full px-4  text-center  ">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10 ">
                    <div class="py-8 px-6">
                        <h3 class="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate">Perpustakaan Lantai 2</h3>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10 ">
                    <div class="py-8 px-6">
                        <h3 class="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate">Perpustakaan Lantai 4 </h3>
                            <p class=" text-base text-secondary mb-6"> 
                            <ul>
                                <li >
                                    IT-604
...
<!-- Rincian Ruangan 14-->
<section id="rincianruangan15" class="pt-10 pb-10 bg-slate-300 ">
    <div class="w-full px-4">
    ...
    <div class="flex">
        ...
        <div id="sliderContainer15" class="w-10/12 overflow-hidden">
            <ul id="slider15" class="flex w-full">
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/perpus/perpus605-2.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">Library 1</a> 
                ...
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white">
                        <img src="dist/img/perpus/perpus605-5.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">Library 2</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 40 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white">
                        <img src="dist/img/perpus/perpus604.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">IT-604</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 50 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white">
                        <img src="dist/img/perpus/perpus605-1.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">IT-605</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 40 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white">
                        <img src="dist/img/perpus/perpus606.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">IT-606</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 35 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white">
                        <img src="dist/img/perpus/perpus606-3.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">IT-608</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 40 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
        ...
        <div class="w-1/12 flex items-center">
            <div class="w-full">
                <button onclick="next15()" class="p-3 rounded-full bg-white border border-gray-100 shadow-lg mr-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
?>
    ...
    <script src="dist/js/slider-perpus.js"></script>
