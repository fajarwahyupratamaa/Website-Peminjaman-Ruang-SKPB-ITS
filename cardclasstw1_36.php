...
?>
    ...
    <!-- Carousel -->
   <section id="carouseltw1_36" class="pt-48 pb-16">
    <div class="max-w-3xl mx-auto ">
        ...
        <div id="default-carousel" class="sticky" data-carousel="static">
            ...
            <div class="overflow-hidden relative h-96 rounded-lg ">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/tower_1/lantai_5/504-1.webp" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
               
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/tower_1/lantai_2/204-6.webp" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
...
<section id="rincianruangantw1_36" class="pt-10 pb-10 bg-slate-100">
    <div class="container">
        <div class="w-full px-4">
            <div class="max-w-xl mx-auto text-center mb-16">
            <h3 class="font-semibold text-xl text-primary mb-2">Rincian Ruangan Bersama Kapasitas 36 di Tower 1</h3>
        ...
        <div class="flex flex-wrap">
            <div class="w-full px-4   text-center ">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10 ">
                    <div class="py-8 px-6">
                        <h3 class="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate">Tower 1 Kapasitas 36 Kursi</h3>
...
<!-- Rincian Ruangan Slider 12-->
<section id="rincianruangan12" class="pt-10 pb-10 bg-slate-200 ">
    <div class="w-full px-4">
    ...
    <div class="flex">
        <div class="w-1/12 flex items-center">
            <div class="w-full text-right">
                <button onclick="prev12()" class="p-3 rounded-full bg-white border border-gray-100 shadow-lg mr-5">
        ...
        <div id="sliderContainer12" class="w-10/12 overflow-hidden">
            <ul id="slider12" class="flex w-full">
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/tower_1/lantai_2/204-6.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">TW1-204</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 36 kursi</p>
                ...
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/tower_1/lantai_2/204-1.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">TW1-304</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 36 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/tower_1/lantai_5/504-1.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">TW1-504</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 36 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/tower_1/lantai_6/604-1.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">TW1-604</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 36 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/tower_1/lantai_7/704-2.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">TW1-704</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 36 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
                <li class="w-72 p-3">
                    <div class="border rounded-xl p-5 bg-white ">
                        <img src="dist/img/tower_1/lantai_8/804.webp" alt="Tower 1" class="h-50 w-full object-cover rounded-md mb-3"/>
                        <a href="#" class="block  font-bold text-xl text-dark hover:text-primary ">TW1-804</a> 
                                <p class=" text-base font-semibold text-secondary mb-1"> Kapasitas : 36 kursi</p>
                            <!-- <a href="cardclasstw1A.php" class="font-medium text-sm text-white bg-primary py-2 px-4 rounded-lg hover:opacity-80 ">Baca Selengkapnya</a> -->
                    </div>
                </li>
        ...
        <div class="w-1/12 flex items-center">
            <div class="w-full">
                <button onclick="next12()" class="p-3 rounded-full bg-white border border-gray-100 shadow-lg mr-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="flex flex-wrap mx-auto">
            ...
            <div class="w-full px-4 mb-12  text-dark font-medium md:w-1/3">
                ...
                <div class=" flex flex-wrap mb-5">
                    ...
                    <p class=" font-bold text-dark  px-2  rounded-lg hover:bg-slate-400">36 Kursi</p>
                </div>
...
?>
    ...
    <script src="dist/js/slider-tw1-36.js"></script>
