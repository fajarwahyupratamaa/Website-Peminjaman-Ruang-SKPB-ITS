...
?>
    ...
    <!-- Carousel -->
   <section id="carouselteatera" class="pt-48 pb-16">
    <div class="max-w-3xl mx-auto ">
        ...
        <div id="default-carousel" class="sticky" data-carousel="static">
            ...
            <div class="overflow-hidden relative h-96 rounded-lg ">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/teater/teatera-5.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
               
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="dist/img/teater/teatera-2.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
        ...
        <div class="flex flex-wrap mx-auto">
            ...
            <div class="w-full px-4 mb-12  text-dark font-medium md:w-1/3">
                ...
                <div class=" flex flex-wrap mb-5">
                    ...
                    <p class=" font-bold text-dark  px-2  rounded-lg hover:bg-slate-400">148 Kursi</p>
                </div>
